...
export function BuyerDashboard({ setView }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 lg:px-6 py-6">
      ...
      <button
        ...
        className="flex items-center gap-1 text-sm text-slate-500 hover:text-teal-700 mb-3"
      >
        ...
        {[
          ...
          >
            ...
            <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${s.c} grid place-items-center mb-3`}>
              <s.i className="w-5 h-5 text-white" />
            </div>
...

          {
            ...
            (
              <span className="text-xs text-slate-500">
                Live updates • {orders.length} total
              </span>
            )
          }
...

        {
          orders.length === 0 ? (
            ...
            <div className="text-center py-12 text-slate-500">
              ...
              <Button
                onClick={() => setView({ name: 'home' })}
                className="mt-3 rounded-full bg-teal-700 hover:bg-teal-800"
              >
                Start Shopping
              </Button>
...

              {
                orders.slice(0,10).map((o)=>(
                  ...
                  <button
                    ...
                    className="w-full text-left rounded-2xl border border-slate-100 p-4 hover:border-teal-300 hover:shadow-md transition"
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-500">
                          {o.items.length} items • {o.address?.city}
                        </div>
                      ...
                      <div className="text-right">
                        ...
                        <Badge className="bg-teal-100 text-teal-700 text-[10px] mt-0.5">
